...
from configureSimulator import configureSimulatorResponse
...
from listUcsTemplates import listUcsTemplatesResponse
...
from disassociateUcsProfileFromBlade import disassociateUcsProfileFromBladeResponse
from refreshUcsBlades import refreshUcsBladesResponse
from instantiateUcsTemplateAndAssocaciateToBlade import instantiateUcsTemplateAndAssocaciateToBladeResponse
...
from addSangforADLoadBalancer import addSangforADLoadBalancerResponse
from configureSangforADLoadBalancer import configureSangforADLoadBalancerResponse
from deleteSangforADLoadBalancer import deleteSangforADLoadBalancerResponse
from listSangforADLoadBalancerNetworks import listSangforADLoadBalancerNetworksResponse
from listSangforADLoadBalanvers import listSangforADLoadBalanversResponse
...
class CloudStackAPIClient(object):
    ...
    def configureSimulator(self, command, method="GET"):
        response = configureSimulatorResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response
    ...
    def listUcsTemplates(self, command, method="GET"):
        response = listUcsTemplatesResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response
    ...
    def disassociateUcsProfileFromBlade(self, command, method="GET"):
        response = disassociateUcsProfileFromBladeResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response

    def refreshUcsBlades(self, command, method="GET"):
        response = refreshUcsBladesResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response

    def instantiateUcsTemplateAndAssocaciateToBlade(self, command, method="GET"):
        response = instantiateUcsTemplateAndAssocaciateToBladeResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response
    ...
    def addSangforADLoadBalancer(self, command, method="GET"):
        response = addSangforADLoadBalancerResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response

    def configureSangforADLoadBalancer(self, command, method="GET"):
        response = configureSangforADLoadBalancerResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response

    def deleteSangforADLoadBalancer(self, command, method="GET"):
        response = deleteSangforADLoadBalancerResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response

    def listSangforADLoadBalancerNetworks(self, command, method="GET"):
        response = listSangforADLoadBalancerNetworksResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response

    def listSangforADLoadBalanvers(self, command, method="GET"):
        response = listSangforADLoadBalanversResponse()
        response = self.connection.marvinRequest(command, response_type=response, method=method)
        return response
