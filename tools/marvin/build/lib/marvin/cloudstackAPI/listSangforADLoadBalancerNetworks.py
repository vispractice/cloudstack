...
"""lists network that are using SangforAD load balancer device"""
from baseCmd import *
from baseResponse import *
class listSangforADLoadBalancerNetworksCmd (baseCmd):
    def __init__(self):
        self.isAsync = "false"
...
class listSangforADLoadBalancerNetworksResponse (baseResponse):
    def __init__(self):
