 ...
 * �ڵ��������Ϣ���ͣ�����/�鿴ʱʹ�ã�
 * 
 * <p>NodeMonitorInfoType complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="NodeMonitorInfoType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="monitor_name" type="{urn:sangfor:ad:api:soap:v1:base}CommonNameType"/&gt;
 *         &lt;element name="base_info" type="{urn:sangfor:ad:api:soap:v1:base}NodeMonitorBaseInfoType"/&gt;
...
@XmlType(name = "NodeMonitorInfoType", propOrder = {
    "monitorName",
    "baseInfo",
    "connectExt",
    "snmpExt",
...
public class NodeMonitorInfoType {

    @XmlElement(name = "monitor_name", required = true)
    protected byte[] monitorName;
    @XmlElement(name = "base_info", required = true)
    protected NodeMonitorBaseInfoType baseInfo;
     ...
     * @return
     *     possible object is
     *     {@link NodeMonitorBaseInfoType }
     *     
     */
    public NodeMonitorBaseInfoType getBaseInfo() {
        return baseInfo;
    }
     ...
     *     
     */
    public void setBaseInfo(NodeMonitorBaseInfoType value) {
        this.baseInfo = value;
    }
