...
public interface LoadBalancingRulesService {
    ...
    LoadBalancer createPublicLoadBalancerRule(String xId, String name, String description, 
            ...
            long networkId, long lbOwnerId, boolean openFirewall, String lbProtocol,String serviceType) throws NetworkRuleConflictException, InsufficientAddressCapacityException;
