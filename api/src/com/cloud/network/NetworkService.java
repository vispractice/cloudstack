...
public interface NetworkService {
    ...
    IpAddress allocateIP(Account ipOwner, long zoneId, Long networkId, String multilineLabel, Boolean displayIp) throws ResourceAllocationException, InsufficientAddressCapacityException,
